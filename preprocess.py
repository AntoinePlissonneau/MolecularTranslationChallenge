...
class TrainDataset(Dataset):
    ...
    def save_max_min(self):
        torch.save(torch.from_numpy(self.max_labels), "F://bms-molecular-translation//data_train_max.pth")
        torch.save(torch.from_numpy(self.min_labels), "F://bms-molecular-translation//data_train_min.pth")
...
class ValDataset(Dataset):
    ...
    def load_max_min(self):
        return torch.load("F://bms-molecular-translation//data_train_max.pth"), torch.load("F://bms-molecular-translation//data_train_min.pth")
